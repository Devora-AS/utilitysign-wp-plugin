 ...
 * @since 1.0.0
 */
function utilitysign_remove_unwanted_scripts_and_styles() {
...
add_action( 'wp_enqueue_scripts', 'utilitysign_remove_unwanted_scripts_and_styles', 100 );

wp_head();

?>
<div id="utilitysign-frontend" class="utilitysign-app"></div>
<?php
