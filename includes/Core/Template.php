 ...
 * Class Template
 *
 * Represents the Template class for UtilitySign.
 *
...
class Template {
	...
	const FRONTEND_TEMPLATE_NAME = 'UtilitySign';
	const FRONTEND_TEMPLATE_SLUG = 'utilitysign';
	...
	public function load_custom_template( $template ) {
		if ( get_page_template_slug() === self::FRONTEND_TEMPLATE ) {
			$template_file_dir = WPB_DIR . 'views/templates/' . self::FRONTEND_TEMPLATE;
