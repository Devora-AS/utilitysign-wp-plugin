...
const fetchData = async () => {
  try {
    const response = await fetch(utilitySign.apiUrl + "utilitysign/v1/accounts/get");
    if (!response.ok) {
    ...
    // Error is re-thrown, no need to log in production
    throw error;
  }
};
...
const deleteAccount = async () => {
  try {
    const response = await fetch(
      utilitySign.apiUrl + "utilitysign/v1/accounts/delete",
    );
    if (!response.ok) {
      throw new Error("Network response was not ok");
    }
